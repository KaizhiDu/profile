...
const EditProfile = ({createProfile, getCurrentProfile, currentProfile, history}) => {
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            skills: !currentProfile.skills ? '' : currentProfile.skills,
            githubusername: !currentProfile.githubusername ? '' : currentProfile.githubusername,
            bio: !currentProfile.bio ? '' : currentProfile.bio,
            twitter: !currentProfile.social ? '' : currentProfile.social.twitter,
            facebook: !currentProfile.social ? '' : currentProfile.social.facebook,
            linkedin: !currentProfile.social ? '' : currentProfile.social.linkedin,
            youtube: !currentProfile.social ? '' : currentProfile.social.youtube,
            instagram: !currentProfile.social ? '' : currentProfile.social.instagram,
        });
    }, []);
...
//we use the withRouter, we can pass the history as props
